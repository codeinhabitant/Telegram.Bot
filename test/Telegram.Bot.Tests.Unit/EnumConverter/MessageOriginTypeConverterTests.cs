...
public class MessageOriginTypeConverterTests
{
    ...
    {
        string messageOriginUnknown = """{"type":"neverEverGoingToBeRealMessageOriginType"}""";

        MessageOrigin? result = JsonSerializer.Deserialize(messageOriginUnknown, TelegramBotClientJsonSerializerContext.Instance.MessageOrigin);
