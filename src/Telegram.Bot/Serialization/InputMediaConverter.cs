...
internal class InputMediaConverter : JsonConverter<InputMedia?>
{
    ...
    public override InputMedia? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        try
        {
            ...
            return type switch
            {
                ...
                _ => JsonSerializer.Deserialize(root.GetRawText(), TelegramBotClientJsonSerializerContext.Instance.InputMediaFallbackUnsupported),
            };
        }
        finally
        {
